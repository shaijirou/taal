...
<head>
    ...
    <style>
        ...
        .stat-card.engagement { background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); }
        .stat-card.content { background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); }
        .stat-card.activity { background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); }
